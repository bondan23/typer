...
//variabel for counting where we typing on the right way
var typeRight = 0;
	...
	initialize: function() {
		...
		var text_input = $('<input>')
			...
			/*.css({
                ...
                //logic for punishment,i only gave the minus one score every make a wrong typing
        ...
        var score_box = $('<div>')
            ...
            .html('Score : <strong class="score-box">'+Score+'</strong>');
